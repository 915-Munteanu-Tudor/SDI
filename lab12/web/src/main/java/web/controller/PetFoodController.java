...
//    @RequestMapping(value = "/petFoods/{petId}", method = RequestMethod.GET)
//    PetFoodsDTO getFoodsForCertainPet(@PathVariable Long petId){
//        logger.trace("filterPetsThatEatCertainFood - method entered");
//        List<PetFood> petFoods = petFoodService.getFoodsForCertainPet(petId);
//        PetFoodsDTO petFoodsDTO = new PetFoodsDTO(petFoodConverter.convertModelsToDTOs(petFoods));
//        logger.trace("filterCatsThatEatCertainFood: " + petFoods);
//        return petFoodsDTO;
//    }
