-only a many-to-many and a one-to-many relationship are needed from the previous lab/problem, the entities that are not involved in these relationships may be dropped
